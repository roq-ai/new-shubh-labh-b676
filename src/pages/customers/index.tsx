            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>debit_loan</Th>
                  <Th>due_date_emi</Th>
                  {hasAccess('bank', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>bank</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>{record.debit_loan}</Td>
                    <Td>{record.due_date_emi as unknown as string}</Td>
                    {hasAccess('bank', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/banks/view/${record.bank?.id}`}>
                          {record.bank?.name}
                        </Link>
                      </Td>
                    )}
